...
**Rhizomata** is a premium, mystical, and philosophical physical board game created by **Amna Noor**. This repository contains the official digital experience and promotional website for the game, featuring a custom-built Content Management System (CMS), high-performance scrolling animations, and an immersive user interface.
## 🌟 Features
