...
if 'Identity Cards Flip CSS' not in content:
    css = """
...
if 'IDENTITY CARDS SHOWCASE' not in content:
    html = """
    <!-- =============================================
...
"""
    content = re.sub(r'<!-- =============================================\n\s*BOARD SHOWCASE SECTION', html + '\n    <!-- =============================================\n       BOARD SHOWCASE SECTION', content)

if 'Identity Cards Flip Logic' not in content:
    js = """
